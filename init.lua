...
-- Open terminal in a horizontal split below (Login Shell)
vim.keymap.set('n', '<leader>ts', ':split | terminal zsh -l<CR>', { desc = 'Open terminal split below' })

-- Open terminal in a vertical split (Login Shell)
vim.keymap.set('n', '<leader>tv', ':vsplit | terminal zsh -l<CR>', { desc = 'Open [T]erminal in [V]ertical split' })
